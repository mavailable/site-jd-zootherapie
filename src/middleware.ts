...
const keystatioCsp = [
  ...
  "font-src 'self'",
  "connect-src 'self' https://api.keystatic.cloud https://keystatic.cloud https://api.github.com https://github.com https://cloud.umami.is https://api-gateway.umami.dev",
